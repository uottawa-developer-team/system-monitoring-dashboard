...
def plotData(data):
    ...
    # Subplot 3 (Total Percentage User):
    ...
    # Subplot 4 (Total Percentage System Processes)
    # Make the trace for systemPct
    fig.add_scatter(x=timestamps, y=systemPct, mode="lines", line=dict(color="Grey"), marker=dict(size=5), name="System Processes", row=2, col=2)
